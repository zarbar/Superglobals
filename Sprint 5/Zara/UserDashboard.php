    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <div style="padding: 40px" class="containerccolour">
            <h1 align="center">
                Welcome <?php 
                if (!empty($_POST)) {echo $_POST['uname'];}
                elseif (!empty($_SESSION)) {echo $_SESSION["username"];} 
                else {echo '';}
                ?>
            ...
            <div style="padding: 30px" align="center">
                ...
                <button type="submit" onclick="window.location.href='LandingPage.php'" class="btn btn-secondary btn-lg" style="background-image:linear-gradient(to right,#cc0099,#ffff33); width: 30%">Logout</button>
            </div> 
